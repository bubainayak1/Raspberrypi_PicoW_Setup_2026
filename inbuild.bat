...
mkdir build 2>nul
cd build
set PICOTOOL=C:\Users\soume\Documents\All_Pico_W_Project\Pico\picotool\build\picotool.exe
REM set PICO_SDK_PATH=C:\Users\soume\Documents\All_Pico_W_Project\Pico\pico-sdk
REM 2. Run CMake
...
C:\Users\soume\Documents\All_Pico_W_Project\Pico\picotool\build\picotool.exe uf2 convert blink.elf blink.uf2
REM "%PICOTOOL%" uf2 convert blink.elf blink.uf2
